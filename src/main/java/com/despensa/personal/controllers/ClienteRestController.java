...
import com.despensa.personal.models.services.IClienteService;
...
public class ClienteRestController {
	...
	public ResponseEntity<?> update(@Valid @RequestBody Cliente cliente, BindingResult result, @PathVariable Long id) {
		...
		if(clienteActual==null) {
			response.put("mensaje", "Error al actualizar el cliente, no existe en la base de datos");
			return new ResponseEntity<Map<String, Object>>(response, HttpStatus.NOT_FOUND);
		}
	...
	public ResponseEntity<?> delete(@PathVariable Long id) {
		...
		response.put("mensaje", "Se ha borrar el cliente en la base de datos");
